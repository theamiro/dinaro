 ...
 */ !(function (t) {
			...
			dt = function (t) {
				...
				return n && n.length
					? n.reduce(function (t, e) {
							var n = {target: e}
							return t.concat(x({config: n, elementApi: m}))
					  }, [])
					: x({config: {target: e}, elementApi: m})
			}
		function pt(t) {
			var e = t.store,
				n = t.actionListId,
			...
			if (f && f.useFirstGroupAsInitialState) {
				...
				l.forEach(function (t) {
					var i = t.config,
						o = t.actionTypeId,
						a = x({config: i, event: c, elementApi: m}),
						u = K(o)
					a.forEach(function (i) {
						var a = u ? Q(o)(i, t) : null
						_t({
							destination: L(
								{element: i, actionItem: t, elementApi: m},
								a
							),
							immediate: !0,
							store: e,
					...
					if (p) {
						...
						x({
							...
							var E = w === e && 0 === p,
								...
								g = L(
									{element: u, actionItem: t, elementApi: m},
									v
								)
							_t({
								store: n,
	...
	function (t, e, n) {
		var r = n(15),
			...
			o = function (t, e) {
				var n = u[a(t)]
				return (
					n == s || (n != c && ("function" == typeof e ? r(e) : !!e))
				)
			},
	...
	function (t, e, n) {
		...
		t.exports = function (t, e, n, r, T, b, A) {
			switch (n) {
				...
				case I:
					return !(
						t.byteLength != e.byteLength || !b(new i(t), new i(e))
					)
				case l:
				case d:
				case h:
	...
	function (t, e, n) {
		...
		Object.defineProperty(e, "__esModule", {value: !0}),
			...
			(e.shouldNamespaceEventParameter = function (t, e) {
				...
				return (
					...
					(t === E.EventTypeConsts.MOUSE_MOVE &&
						n === E.EventBasedOn.ELEMENT)
				)
			}),
		...
		function yt(t) {
			...
			if (
				(x
					? ((S = N.limitAffectedElements), (w = C), (R = u(N)))
		...
		function Mt(t, e, n) {
			...
			Ct(t, e, n),
				...
				e === y.TRANSFORM_PREFIXED &&
					r(t, y.TRANSFORM_STYLE_PREFIXED, "")
		}
		function jt(t) {
			var e = 0,
				n = 0
				...
				function l(n) {
					if (
						!(
							r.env("design") ||
							(window.$.mobile &&
								t(n.currentTarget).hasClass("ui-link"))
						)
					) {
				...
				function G(t, e) {
					if (!t.open) {
						;(t.open = !0),
							...
							t.button.addClass(_)
						var n = t.config
						;("none" !== n.animation && f.support.transform) ||
							(e = !0)
						var i = k(t),
...
Webflow.require("ix2").init({
	...
	actionLists: {
		a: {
					...
					actionItems: [
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|5f86c1437b656db99939d763",
								},
								value: 0,
								unit: "",
							},
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|ad93e201-8caa-7292-aaf8-ebcbf14f67f7",
								},
								value: 0,
								unit: "",
							},
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|85f6c184-5919-6124-a052-00ffcd768e74",
								},
								value: 0,
								unit: "",
							},
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|152f9040-1ac5-8121-b8f0-97778ce3e8aa",
								},
								value: 0,
								unit: "",
							},
					...
					actionItems: [
						...
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|75ff64b8-332a-8988-ab24-fb32e7ad3e52",
								},
								xValue: 65,
								xUnit: "PX",
								yUnit: "PX",
						...
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|8a067a60-b4db-ae25-2a5b-4426baf4dfaf",
								},
								xValue: -65,
								xUnit: "PX",
								yUnit: "PX",
						...
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									id: "5f86c143aaed3118895c6fa1|6d3743e4-8a20-ad10-76bf-50cc9dd035b4",
								},
								yValue: -125,
								xUnit: "PX",
								yUnit: "PX",
					...
					actionItems: [
						{
							...
							config: {
								...
								duration: 200,
								target: {
									id: "5f86c143aaed3118895c6fa1|24a798dd-c06d-e350-607f-d4ca63498344",
								},
								yValue: -10,
								xUnit: "PX",
								yUnit: "PX",
			...
			createdOn: 1602674354113,
			useFirstGroupAsInitialState: true,
		},
		"a-2": {
			id: "a-2",
			title: "animate-devices",
			continuousParameterGroups: [
				{
					id: "a-2-p",
...
$(document).ready(function () {
	var $clone = $(".slide-track").children().clone()
	$clone.clone().appendTo(".slide-track")
...
function checkVisibility() {
	...
	$.each($body.find(".transition-enabled"), function () {
		...
		o <= i + s && i <= t
			...
			: o <= 120 && e.removeClass("is-visible")
	})
	$.each($body.find(".blob"), function () {
		var e = $(this)
		e.css({top: o / 10 + "px"})
	})
}
